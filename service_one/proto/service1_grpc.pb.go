...
func (c *serviceClient) UpdateFirstName(ctx context.Context, in *UpdateFirstNameRequest, opts ...grpc.CallOption) (*UpdateFirstNameResponse, error) {
	out := new(UpdateFirstNameResponse)
	err := c.cc.Invoke(ctx, "/proto.Service/UpdateFirstName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_UpdateFirstName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateFirstNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).UpdateFirstName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Service/UpdateFirstName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).UpdateFirstName(ctx, req.(*UpdateFirstNameRequest))
	}
